...
class WeatherApiService {
  final String apiKey =
      'Y4XW6SDSGYERQMFFTGH3FL34Y'; // Replace with your actual Visual Crossing API key
  final String apiUrl =
  ...
  void startAutoRefresh(double latitude, double longitude,
      Function(Map<String, dynamic>) onWeatherUpdated) {
